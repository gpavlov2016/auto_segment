...
if __name__ == '__main__':
    ...
    img_marking = cv2.imread(inputfile)  # imread wont rise exceptions by default
    img_marking = cv2.resize(img_marking, None, fx=0.2, fy=0.2, interpolation=cv2.INTER_CUBIC)

    img = cv2.imread(inputfile)  # imread wont rise exceptions by default
